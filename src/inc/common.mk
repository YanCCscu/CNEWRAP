...
CONFIG_FILES = \
	...
	labs.ra
CV = cv.ra
CVDIR=${BASE_BIN}/kent/src/hg/makeDb/trackDb/cv/alpha
...
CC_PROG_OPTS = ${COPT} ${CFLAGS} ${HG_DEFS} ${LOWELAB_DEFS} ${HG_WARN} ${HG_INC} ${XINC} -static
%.o: %.c
	${CC} ${CC_PROG_OPTS}  -o $@ -c $<
